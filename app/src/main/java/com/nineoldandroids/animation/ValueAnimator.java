...
public class ValueAnimator extends Animator {
    ...
    private static class AnimationHandler extends Handler {
         ...
         * ANIMATION_FRAME. The START MessageNotificationActivity is sent when an animation's start()
         * method is called. It cannot start synchronously when start() is called
         * because the call may be on the wrong thread, and it would also not be
         * synchronized with other animations because it would not start on a common
         * timing pulse. So each animation sends a START MessageNotificationActivity to the handler, which
         * causes the handler to place the animation on the active animations queue and
         * start processing frames for that animation.
         * The FRAME MessageNotificationActivity is the one that is sent over and over while there are any
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                // TODO: should we avoid sending frame MessageNotificationActivity when starting if we

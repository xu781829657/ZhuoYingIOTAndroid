...
public class ArcProgress extends View {
    ...
    private final int default_finished_color =  Color.rgb(250, 201, 77);
    private final int default_unfinished_color =  Color.rgb(49, 201, 218);
    private final int default_text_color = Color.rgb(49, 201, 218);
